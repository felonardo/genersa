...
//                        TextFieldComponent(field: $viewModel.nickname, alignment: .leading, placeholder: "Your Nickname", errorState: $viewModel.nicknameError, isEditing: true)
//                    }
...
//                        TextFieldComponent(field: $viewModel.fieldTrip, alignment: .leading, placeholder: "My Trip", errorState: $viewModel.errorState, isEditing: true)
//                    }
//                }
//                .onTapGesture {
//                    endTextEditing()
//                }
                ReusableTitleView(title: "Saving Period", description: "", errorState: .constant(false)){
                    HStack {
                        Spacer()
                        TripDatePicker()
                        Spacer()
